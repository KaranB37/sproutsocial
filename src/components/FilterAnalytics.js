      ...
      {analyticsData && (
        <Card className="mb-4">
          <CardContent className="p-4">
            ...
            <p className="mb-4">
              <span className="font-semibold">Metrics:</span> {metrics.join(", ")}
            </p>
                ...
                <tbody>
                  {analyticsData.data[0]?.data_points.map((point, index) => (
                    <tr key={index} className={index % 2 === 0 ? "bg-gray-50" : "bg-white"}>
                      <td className="py-2 px-4 border-b border-gray-200">{point.date}</td>
                      <td className="py-2 px-4 border-b border-gray-200">{point.network}</td>
                      {metrics.map((metric) => (
                        <td key={metric} className="py-2 px-4 border-b border-gray-200">
